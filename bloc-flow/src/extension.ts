...
export class Dependency extends vscode.TreeItem {
  constructor(
    ...
    private readonly version: string // public readonly collapsibleState: vscode.TreeItemCollapsibleState, // public readonly command?: vscode.Command
  ) {
...
class ColorsViewProvider implements vscode.WebviewViewProvider {
  ...
  constructor(private readonly _extensionUri: vscode.Uri) {
    fetch('https://raw.githubusercontent.com/DoanpPhiHo/vs_bloc_extension/master/bloc-flow/assets/data.json')
      .then((value) => value.json()).then((value) => {
        for (let i = 0; i < value.code.length; i++) {
          console.log(value.code[i]);
