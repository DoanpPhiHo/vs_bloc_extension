...
class ColorsViewProvider implements vscode.WebviewViewProvider {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    return `<!DOCTYPE html>
			...
			<body>
        		<iframe id="ho_doan" frameborder="0" sandbox="allow-scripts allow-same-origin" scrolling="yes" flex-grow=1 width="100%" height="100%" src="https://ho-doan.github.io"></iframe>
